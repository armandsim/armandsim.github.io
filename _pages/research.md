...
*Health Economics, 2024, 33(5): 992–1032.* <button onclick="toggleAbstract(this)" class="abstract-toggle">[abstract]</button>
...
*European Economic Review, 2024, 163, 104683* <button onclick="toggleAbstract(this)" class="abstract-toggle">[abstract]</button>
...
*World Development, 2017, 91: 144–155.* <button onclick="toggleAbstract(this)" class="abstract-toggle">[abstract]</button>
...
**[Sink or Swim: Testing the Role of Science vs Religion in Raising Environmental Awareness in Indonesia](/docs/jakarta_draft.pdf)** with Sarah Gultom, Alyas Widita, Umair Khalil, Wang Lee, <button onclick="toggleAbstract(this)" class="abstract-toggle">[abstract]</button>
...
*Revised and resubmitted, Journal of Health Economics* <button onclick="toggleAbstract(this)" class="abstract-toggle">[abstract]</button>
...
function toggleAbstract(button) {
  ...
  button.textContent = isHidden ? '[hide]' : '[abstract]';
}
</script>
